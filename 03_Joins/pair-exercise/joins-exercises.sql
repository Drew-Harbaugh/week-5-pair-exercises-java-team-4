...
WHERE city.population > 1000000 AND country.continent LIKE 'Europe';
...
JOIN countrylanguage ON country.code = countrylanguage.countrycode 
WHERE countrylanguage.language LIKE 'Javanese'; 

-- 4. The names of all of the countries in Africa that speak French as an official language
-- (5 row)
SELECT country.name, country.continent FROM country
JOIN countrylanguage ON country.code = countrylanguage.countrycode 
WHERE countrylanguage.language LIKE 'French' AND isofficial AND country.continent = 'Africa';  

-- 5. The average city population of cities in Europe
-- (average city population in Europe: 287,684)
SELECT round(AVG(city.population)) FROM city 
JOIN country ON city.countrycode = country.code 
...
JOIN country ON city.countrycode = country.code
JOIN countrylanguage ON country.code = countrylanguage.countrycode
WHERE countrylanguage.language LIKE 'English' AND isofficial;
